...
public final class GntMediumTemplateViewBinding implements ViewBinding {
  ...
  private GntMediumTemplateViewBinding(@NonNull View rootView,
  ...
  public static GntMediumTemplateViewBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new GntMediumTemplateViewBinding(rootView, background, body, content, cta, headline,
          icon, mediaView, middle, nativeAdView, primary, secondary, txtAds, txtFull);
    }
